...
import AddText from './Step02-Text/DeckText';
import AddStickers from './Step03-Stickers/AddStickers'

export default function DeckBox(props: any) {
  const PageDisplay = () => {
    if (props.page === 1) {
      return <AddColorSize deckWidth={ props.deckWidth } deckColor={ props.deckColor } handleChange={ props.handleChange }/>;
    } else if (props.page === 2) {
      return <AddText handleCopyChange={ props.handleCopyChange } deckText={ props.deckText } deckTextColor={ props.deckTextColor } handleTextColorChange={ props.handleTextColorChange }/>;
      ...
      <div className="deckbox">
        { (props.textInit || props.page >=2) && (
          <div className="text-box">
            <div style={{ height: 220, color: props.deckTextColor }}>
